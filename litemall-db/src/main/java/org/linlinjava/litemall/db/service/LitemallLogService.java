...
public class LitemallLogService {
    ...
    public List<LitemallLog> querySelective(String name, Boolean status, String startTime, String endTime, Integer page, Integer size, String sort, String order) {
        ...
        if (!StringUtils.isEmpty(startTime)) {
            criteria.andAddTimeGreaterThanOrEqualTo(LocalDateTime.parse(startTime));
        }
        
        if (!StringUtils.isEmpty(endTime)) {
            criteria.andAddTimeLessThanOrEqualTo(LocalDateTime.parse(endTime));
        }
